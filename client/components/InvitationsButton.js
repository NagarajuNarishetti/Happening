  ...
  return (
    <div className="relative" ref={containerRef}>
      <button
        ...
        className={`px-4 py-2 bg-white/80 backdrop-blur-md text-gray-700 rounded-xl hover:bg-white hover:shadow-lg transition-all font-semibold shadow-xl flex items-center gap-2 group border border-blue-200/50 hover:border-blue-300 tracking-wide ${iconOnly ? 'px-3' : ''}`}
